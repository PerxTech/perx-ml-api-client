...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("perxtech/ml/v1beta1/reward_recommendation.proto", :syntax => :proto3) do
    add_message "perxtech.ml.v1beta1.RewardRecommendationRequest" do
...
module Perxtech
  module Ml
    module V1beta1
      RewardRecommendationRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("perxtech.ml.v1beta1.RewardRecommendationRequest").msgclass
