...
from perxtech.ml_v1beta1.services.reward_recommendation import RewardRecommendationClient
from perxtech.ml_v1beta1.services.reward_recommendation import transports
...
def test_reward_recommendation_client_from_service_account_file():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_file') as factory:
        ...
        client = RewardRecommendationClient.from_service_account_file("dummy/file/path.json")
        assert client._transport._credentials == creds

        client = RewardRecommendationClient.from_service_account_json("dummy/file/path.json")
        assert client._transport._credentials == creds
...
def test_reward_recommendation_client_client_options():
    ...
    with mock.patch('perxtech.ml_v1beta1.services.reward_recommendation.RewardRecommendationClient.get_transport_class') as gtc:
...
def test_get_recommendation(transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client._transport.get_recommendation),
            '__call__') as call:
    ...
    assert isinstance(response, reward_recommendation.RewardRecommendationResponse)
...
def test_reward_recommendation_base_transport():
    # Instantiate the base transport.
    transport = transports.RewardRecommendationTransport(
        credentials=credentials.AnonymousCredentials(),
    )
...
def test_reward_recommendation_host_no_port():
    client = RewardRecommendationClient(
        credentials=credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='ml-api.data.perxtech.net'),
        transport='grpc',
    )
    assert client._transport._host == 'ml-api.data.perxtech.net:443'
...
def test_reward_recommendation_host_with_port():
    client = RewardRecommendationClient(
        credentials=credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='ml-api.data.perxtech.net:8000'),
        transport='grpc',
    )
    assert client._transport._host == 'ml-api.data.perxtech.net:8000'


def test_reward_recommendation_grpc_transport_channel():
